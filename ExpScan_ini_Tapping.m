...
if BIN_X==2
    ...
    PathDataIn='Data\ScanHead\DataTokyo\130627_Motor_Tapping\05_prep_data_firstrun\'; % use 'Data\ScanHead\for_polimi_dat_1x\' for 1x, 'Data\ScanHead\for_polimi_dat\' for 4x
else
...
PathDataOut='Analysis\ScanHead\ResultsTokyo\TomoTokyo\';
%FileNameIn='S04_2_DTOFarray_6D_single_binxy_nobs_blocksum.mat';
FileNameIn='130627_Motor_Tapping_DTOFarray_6D_single_binxy_nobs_blocksum.mat';
if BIN_X==2
    FileNameOut='EXP_DATA_EXP_2x_tapping.mat';
else
